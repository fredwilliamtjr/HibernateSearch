...
public class PersistenceProperties {
    ...
    public static Properties get() throws Exception {
        ...
        System.out.println("***** ENTROU NO METODO GET DO PersistenceProperties *****");
    ...
    private static Properties userHomeJdbcFile() throws Exception {
        ...
        System.out.println("**** O CAMINHO user.home É : " + System.getProperty("user.home") + " ****");
        System.out.println("**** O CAMINHO user.dir É : " + System.getProperty("user.dir") + " ****");
        System.out.println("**** O CAMINHO java.class.path É : " + System.getProperty("java.class.path") + " ****");
        
        Properties props = new Properties();
        
        File fileProperties = new File(System.getProperty("user.dir"), "jdbc.properties");
